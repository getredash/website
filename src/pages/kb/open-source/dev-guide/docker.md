...
file to see the full configuration. If you hit an `errno 137` particularly at `RUN npm run build`,
make sure you give your Docker VM enough memory (recommended 4GB)
