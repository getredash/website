...
1. Use the "Query Results" data source and your query id as a table (select ..... from query_123), then you'll need to query it with SQLite syntax. Read more about query results as data sources [here](queries/using-datasets-as-data-sources.md).
