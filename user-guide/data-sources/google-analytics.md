...
To apply further manipulation on the data set you get from querying Google Analytics you can use the Query Results data source, read more [here](../queries/using-datasets-as-data-sources.md)
